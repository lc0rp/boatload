...
assert(indexHtml.includes('id="nudgeProject"'), "expected project toolbar to expose a Nudge Project action");
assert(indexHtml.includes('title="Nudge Project"'), "expected nudge action tooltip to use the requested label");
assert(indexHtml.includes('>Nudge <span class="shortcut">N</span>'), "expected nudge action to show the N shortcut");
...
assert(appJs.includes('nudgeProject.addEventListener("click", handleNudgeProjectClick)'), "expected nudge project link to be refreshed before navigation");
assert(appJs.includes('if (key === "n") return openNudgeProjectLink();'), "expected N shortcut to open the nudge deep link");
