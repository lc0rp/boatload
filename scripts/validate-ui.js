...
assert(indexHtml.includes('id="projectClear"'), "expected project selector to expose a clear button");
assert(indexHtml.includes('aria-label="Clear project"'), "expected project clear button to be accessible");
...
assert(appJs.includes('projectClear.addEventListener("click", clearProjectSelect)'), "expected project clear button to clear the selector");
assert(appJs.includes('function updateProjectClearButton()'), "expected project clear visibility to track selector value");
assert(stylesCss.includes(".issue-search"), "expected issue search styling");
assert(stylesCss.includes(".project-clear"), "expected project clear button styling");
